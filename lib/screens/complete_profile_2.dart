              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(color: const Color(0xFF00A886), width: 1),
                  ),
                  child: Padding(
                      ...
                      child: DropdownButtonHideUnderline(
                        child: Padding(
                          ...
                          child: DropdownButton<String>(
                            ...
                            hint: Text("she/her, they/them", style: TextStyle(color: Colors.grey,fontFamily: "Nunito", fontSize: 14*widthMultiplier)),
                            ...
                            items: pronounOptions.map<DropdownMenuItem<String>>((String value) {
